...
/obj/item/encryptionkey/all
	...
	channels = list(ERT_FREQ_NAME = 1, DTH_FREQ_NAME = 1, SCI_FREQ_NAME = 1, COMM_FREQ_NAME = 1, MED_FREQ_NAME = 1, ENG_FREQ_NAME = 1, SEC_FREQ_NAME = 1, SUP_FREQ_NAME = 1, SRV_FREQ_NAME = 1, PRS_FREQ_NAME = 1, PROC_FREQ_NAME = 1, T1_FREQ_NAME = 1, T2_FREQ_NAME = 1, T3_FREQ_NAME = 1 ) // just in case
	syndie = TRUE
	change_voice = FALSE
